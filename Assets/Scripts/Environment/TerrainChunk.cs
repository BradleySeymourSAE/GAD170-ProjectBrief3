...
public class TerrainChunk
{
	...
	public void Load()
	{
		ThreadedDataRequester.RequestData(() => EnvironmentHeightMapGenerator.CreateHeightMap(meshSettings.numberOfVerticesPerLine, meshSettings.numberOfVerticesPerLine, heightMapSettings, sampleCentre), OnHeightMapReceived);
	}
	...
	public void UpdateCollisionMesh()
	{
		if (!hasSetCollider)
		{
			...
			if (sqrDstFromViewerToEdge < detailLevels[colliderLODIndex].VisibleDistanceThresholdSquared)
			{
...
class LODMesh
{
	...
	public void RequestMesh(HeightMap heightMap, MeshSettings meshSettings)
	{
		...
		ThreadedDataRequester.RequestData(() => EnvironmentMeshGenerator.CreateTerrainMesh(heightMap.values, meshSettings, lod), OnMeshDataReceived);
	}
}
